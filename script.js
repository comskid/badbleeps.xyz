...
function initializeTypingEffect() {
    ...
    const texts = [
        'made by some random french dude',
        'amazing artist',
        'ticket slave',
        'd1 skidder',
        'cs2 enjoyer'
...
async function updateDiscordStatus() {
    try {
        ...
        console.log('couldnt retrieve discord data:', error);
    }
}
...
function updateDiscordUI(userData) {
    ...
    if (mainStatusText) {
        mainStatusText.textContent = statusTexts[status] || 'Status unknown';
    }
